...
<body style="background-color: #ff0000; color: #fff;">
    <div class="container-scroller">
                    ...
                    <li class="nav-item nav-search d-none d-lg-block">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="navbar-search-input" placeholder="Search now"
                                ...
                                style="background-color: #ffffff; color: #31302c; border: none; border-radius: 4px;">
                        </div>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown"
                            style="background-color: #31302c; color: #fff;">
        ...
        <div class="container-fluid page-body-wrapper"
            style="background-color: #ffffff; color: #fff; border-radius: 12px; overflow: hidden;">
            ...
            <nav class="sidebar sidebar-offcanvas"
                style="background-color: #000000; color: #000000; overflow: hidden;" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
